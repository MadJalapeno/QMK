...
## Notes for Boardsource Corne Kit using Blok

To make a version of the UTF file to install run on a blok from boardsource.xyz

```sh
qmk compile -kb crkbd/rev1 -km madjalapeno -e CONVERT_TO=blok"
```

I am using the keymap in crkbd/keympas/madjalapeno as there are some changes I like to make using the keyboard 
with SolidWorks easier.
